...
public class EquipmentController {
	...
	@RequestMapping("/equipment/searchEquipment.do")
	public String selectEquipmentSearch(@RequestParam(value = "cPage", required = false, defaultValue = "1") int cPage,
			Model model,String eqName) {
		int limit = 10; // 한 페이지 당 게시글 수

		// 1. 현재 페이지 게시글 목록 가져오기
		ArrayList<Map<String, String>> list = new ArrayList<>(equipmentService.selectEquipmentListSearch(cPage, limit,eqName));
